...
import co.weepa.smile.contabilidad.payu.interfaces.IPagosRecurrentes;
 ...
 */
public class PagosRecurrentesPayU implements IPagosRecurrentes {
	...
	public String agregarCliente(ObjPayuCliente cliente) throws ExcepcionesPayU {
		...
		return "Saliendo de agregarCliente";
	}
